...
+ (void)registerForNetworkReachabilityNotifications
{
	[[AReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[AReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
